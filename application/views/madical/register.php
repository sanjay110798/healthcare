...
<form action="<?php echo base_url();?>madical/registerInformation" method="post">
...
<div class="text-center dont-have">Already have an account? <a href="<?php echo base_url();?>madical/login">Login</a></div>
</div>
</div>
</div>
</div>
