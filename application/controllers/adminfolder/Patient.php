...
class Patient extends CI_Controller {
	...
	public function __construct()
	{
     ...
     public function index()
     {
     	...
     	$result['patient']=$this->db->get_where('users',array('role_id'=>3))->result();
     	$this->load->view('layout/admin/dashboard/header');
      $this->load->view('layout/admin/dashboard/sidebar');
     	$this->load->view('admin/patient/index',$result);
     ...
     {
     	$this->db->order_by('id','desc');
     	$result['patient']=$this->db->get_where('users',array('id'=>$id))->row();
     	$this->load->view('layout/admin/dashboard/header');
        $this->load->view('layout/admin/dashboard/sidebar');
     	$this->load->view('admin/patient/edit',$result);
     	$this->load->view('layout/admin/dashboard/footer');
     ...
     public function insert()
     {
     	...
     	if($checkUser)
     	{
     		...
     		redirect('adminfolder/patient/add');
     	}
		...
		$user['profile_image']=$fl_name;
     	...
     	$this->session->set_flashdata('success','Patient Added Successfully!!','refresh');

     	redirect('adminfolder/patient');
     }
     public function update($id)
     {
     	...
     	{
     		$this->session->set_flashdata('error','User Already Exsist!!','refresh');
     		redirect('adminfolder/patient/edit/'.$id);
     	}
		...
		if($this->input->post('password')!='')
     	...
     	$this->session->set_flashdata('success','Patient Edited Successfully!!','refresh');
     ...
     public function delete($id)
     {
      ...
      $this->session->set_flashdata('warning','Patient Deleted Successfully!!','refresh');
